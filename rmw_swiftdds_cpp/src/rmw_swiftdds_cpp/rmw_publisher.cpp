  ...
  const rmw_publisher_options_t *publisher_options)
{
  ...
  auto cleanup_publisher = rcpputils::make_scope_exit([participant_info, publisher]() {
  ...
  // Update graph
  if(RMW_RET_OK !=
    common_context->add_publisher_graph(info->publisher_gid, node->name, node->namespace_))
  {
    return nullptr;
  }
  ...
  size_t *subscription_count)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_publisher_count_matched_subscriptions(publisher,
                                                                              subscription_count);
}

rmw_ret_t rmw_publisher_assert_liveliness(const rmw_publisher_t *publisher)
{
  return rmw_swiftdds_shared_cpp::__rmw_publisher_assert_liveliness(greenstone_swiftdds_identifier,
                                                                    publisher);
}
