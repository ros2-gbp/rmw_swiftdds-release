...
#ifndef RMW_SWIFTDDS_SHARED_CPP__DEMANGLE_HPP_
#define RMW_SWIFTDDS_SHARED_CPP__DEMANGLE_HPP_
...
/// Return the service name for a given topic if it is part of a service
/// request, else "".
std::string _demangle_service_request_from_topic(const std::string & topic_name);

/// Return the service name for a given topic if it is part of a service reply,
/// else "".
...
#endif  // RMW_SWIFTDDS_SHARED_CPP__DEMANGLE_HPP_
