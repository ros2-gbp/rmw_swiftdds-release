...
%description
Implement the ROS middleware interface using SWIFT DDS static code generation in
C++.
...
%changelog
* Fri Jul 17 2026 greenstonesoft <gitsupport@greenstonesoft.com> - 1.0.1-1
