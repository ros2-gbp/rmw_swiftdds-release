...
{
  return rmw_swiftdds_shared_cpp::rmw_init_options_fini(greenstone_swiftdds_identifier,
                                                        init_options);
}
...
rmw_ret_t rmw_init(const rmw_init_options_t *options, rmw_context_t *context)
{
  ...
  auto restore_context = rcpputils::make_scope_exit([context]() {
  ...
  auto cleanup_impl = rcpputils::make_scope_exit([context]() {
        delete context->impl;
  });
