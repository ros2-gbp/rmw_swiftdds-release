...
using GetNamesAndTypesByNodeFunction = rmw_ret_t (*)(rmw_dds_common::Context *,
                                                     const std::string &,
                                                     const std::string &,
                                                     DemangleFunction,
                                                     DemangleFunction,
  ...
  rmw_names_and_types_t *topic_names_and_types)
{
  ...
  return get_names_and_types_by_node(common_context,
                                     node_name,
                                     node_namespace,
                                     demangle_topic,
                                     demangle_type,
...
__rmw_get_subscriber_names_and_types_by_node(
  ...
  rmw_names_and_types_t *topic_names_and_types)
{
  return __rmw_get_topic_names_and_types_by_node(identifier,
                                                 node,
                                                 allocator,
                                                 node_name,
                                                 node_namespace,
