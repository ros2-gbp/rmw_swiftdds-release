  ...
  rmw_publisher_t *publisher)
{
  ...
  // Update graph
  rmw_ret_t rmw_ret =
    common_context->remove_publisher_graph(info->publisher_gid, node->name, node->namespace_);
  ...
  void *loaned_message)
{
  ...
  auto info = static_cast<CustomPublisherInfo *>(publisher->data);
  if(info->data_writer_->return_loan(loaned_message) != greenstone::dds::ReturnCode_t::RETCODE_OK) {
    return RMW_RET_ERROR;
  }
